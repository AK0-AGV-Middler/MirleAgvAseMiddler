...
namespace Mirle.Agv.Controller
{
    ...
    public class MiddleAgent
    {
        ...
        protected void ClientAgent_OnConnectionChangeEvent(object sender, TcpIpEventArgs e)
        {
            ...
            OnMessageShowOnMainFormEvent?.Invoke(this, $"Middler : ClientAgent OnConnection Change Event, [AgentName={agent.Name}][IsConnect={agent.IsConnection}]");
        }
        ...
        public void StartAskReserve()
        {
            ...
            var msg = $"Middler : Start Ask Reserve, [NeedReserveSectionIds={QueMapSectionsToString(queNeedReserveSections)}]";
            OnMessageShowOnMainFormEvent?.Invoke(this, msg);
            loggerAgent.LogMsg("Comm", new LogFormat("Comm", "1", GetType().Name + ":" + MethodBase.GetCurrentMethod().Name, "Device", "CarrierID"
                     , msg));
        }
        public void PauseAskReserve()
        {
            ...
            var msg = $"Middler : Pause Ask Reserve, [AskingReserveSectionId={askingReserveSection.Id}]";
            OnMessageShowOnMainFormEvent?.Invoke(this, msg);
            loggerAgent.LogMsg("Comm", new LogFormat("Comm", "1", GetType().Name + ":" + MethodBase.GetCurrentMethod().Name, "Device", "CarrierID"
                 , msg));
        }
        public void ResumeAskReserve()
        {
            ...
            var msg = $"Middler : Resume Ask Reserve, [AskingReserveSectionId={askingReserveSection.Id}]";
            OnMessageShowOnMainFormEvent?.Invoke(this, msg);
            loggerAgent.LogMsg("Comm", new LogFormat("Comm", "1", GetType().Name + ":" + MethodBase.GetCurrentMethod().Name, "Device", "CarrierID"
                 , msg));
        ...
        {
            var msg = $"Middler : Pre Ask Reserve, [NeedReserveSectionIds={QueMapSectionsToString(queNeedReserveSections)}]";
            OnMessageShowOnMainFormEvent?.Invoke(this, msg);
            loggerAgent.LogMsg("Comm", new LogFormat("Comm", "1", GetType().Name + ":" + MethodBase.GetCurrentMethod().Name, "Device", "CarrierID"
                , msg));
        ...
        private void AfterAskReserve(long total)
        {
            ...
            var msg = $"MainFlow : After Ask Reserve, [ThreadStatus={AskReserveStatus}][TotalSpendMs={total}]";
            OnMessageShowOnMainFormEvent?.Invoke(this, msg);
            loggerAgent.LogMsg("Comm", new LogFormat("Comm", "1", GetType().Name + ":" + MethodBase.GetCurrentMethod().Name, "Device", "CarrierID"
                , msg));
        }
        ...
        {
            double result = 0;
            List<MapSection> reserveOkSections = new List<MapSection>(queGotReserveOkSections);
        ...
        {
            queNeedReserveSections = new ConcurrentQueue<MapSection>();
            var msg = $"Middler : ClearNeedReserveSections, [QueCount={queNeedReserveSections.Count}]";
            OnMessageShowOnMainFormEvent?.Invoke(this, msg);
        ...
        {
            askingReserveSection = new MapSection();
            var msg = $"Middler : ClearAskingReserveSection, [QueCount={queNeedReserveSections.Count}]";
            OnMessageShowOnMainFormEvent?.Invoke(this, msg);
            loggerAgent.LogMsg("Debug", new LogFormat("Debug", "1", GetType().Name + ":" + MethodBase.GetCurrentMethod().Name, "Device", "CarrierID"
                 , msg));
        }
        ...
        {
            queGotReserveOkSections = new ConcurrentQueue<MapSection>();
            var msg = $"Middler : ClearGotReserveOkSections, [QueCount={queGotReserveOkSections.Count}]";
            OnMessageShowOnMainFormEvent?.Invoke(this, msg);
            loggerAgent.LogMsg("Debug", new LogFormat("Debug", "1", GetType().Name + ":" + MethodBase.GetCurrentMethod().Name, "Device", "CarrierID"
                 , msg));
        }
        ...
        public MapSection GetAskingReserveSectionClone()
        {
        ...
        public void SetupNeedReserveSections(MoveCmdInfo moveCmd)
        {
            ...
            var msg = $"Middler : SetupNeedReserveSectionsByMoveCmd, [QueCount={queNeedReserveSections.Count}]";
            OnMessageShowOnMainFormEvent?.Invoke(this, msg);
            loggerAgent.LogMsg("Debug", new LogFormat("Debug", "1", GetType().Name + ":" + MethodBase.GetCurrentMethod().Name, "Device", "CarrierID"
                 , msg));
        }
        public void SetupNeedReserveSections(List<MapSection> mapSections)
        {
            ...
            var msg = $"Middler : SetupNeedReserveSectionsByList, [QueCount={queNeedReserveSections.Count}]";
            OnMessageShowOnMainFormEvent?.Invoke(this, msg);
            loggerAgent.LogMsg("Debug", new LogFormat("Debug", "1", GetType().Name + ":" + MethodBase.GetCurrentMethod().Name, "Device", "CarrierID"
                 , msg));
        }
        ...
        {
            if (queGotReserveOkSections.Count == 0)
            {
                var msg = $"Middler : DequeueGotReserveOkSections +++FAIL+++, [QueCount={queGotReserveOkSections.Count}]";
                OnMessageShowOnMainFormEvent?.Invoke(this, msg);
                loggerAgent.LogMsg("Error", new LogFormat("Error", "1", GetType().Name + ":" + MethodBase.GetCurrentMethod().Name, "Device", "CarrierID"
                     , msg));
                return;
            ...
            else
            {
                ...
                var msg = $"Middler : DequeueGotReserveOkSections +++Ok+++, [SectionId={passSection.Id}]";
                OnMessageShowOnMainFormEvent?.Invoke(this, msg);
                loggerAgent.LogMsg("Debug", new LogFormat("Debug", "1", GetType().Name + ":" + MethodBase.GetCurrentMethod().Name, "Device", "CarrierID"
                     , msg));
            }
        ...
        public void DequeueNeedReserveSections()
        {
            if (queNeedReserveSections.Count == 0)
            {
                var msg = $"Middler : DequeueNeedReserveSections +++FAIL+++, [QueCount={queNeedReserveSections.Count}]";
                OnMessageShowOnMainFormEvent?.Invoke(this, msg);
                loggerAgent.LogMsg("Error", new LogFormat("Error", "1", GetType().Name + ":" + MethodBase.GetCurrentMethod().Name, "Device", "CarrierID"
                     , msg));
            }
            else
            {
                ...
                var msg = $"Middler : DequeueNeedReserveSections +++Ok+++, [SectionId={dequeueSection.Id}]";
                OnMessageShowOnMainFormEvent?.Invoke(this, msg);
                loggerAgent.LogMsg("Debug", new LogFormat("Debug", "1", GetType().Name + ":" + MethodBase.GetCurrentMethod().Name, "Device", "CarrierID"
                     , msg));
        ...
        public void Send_Cmd144_StatusChangeReport()
        {
            ...
            try
            {
                ...
                iD_144_STATUS_CHANGE_REP.HasCST = VhLoadCSTStatusParse(theVehicle.ThePlcVehicle.Loading);
                ...
                iD_144_STATUS_CHANGE_REP.CSTID = theVehicle.ThePlcVehicle.CassetteId;
        ...
        public void Send_Cmd143_StatusResponse(ushort seqNum)
        {
            ...
            try
            {
                ...
                iD_143_STATUS_RESPONSE.CSTID = theVehicle.ThePlcVehicle.CassetteId;
        ...
        public void Send_Cmd136_TransferEventReport(EventType eventType)
        {
            ...
            try
            {
                ...
                iD_136_TRANS_EVENT_REP.CSTID = string.IsNullOrEmpty(theVehicle.ThePlcVehicle.CassetteId) ? "" : theVehicle.ThePlcVehicle.CassetteId;
        ...
        public void Send_Cmd136_CstIdReadReport(EnumIdReadResult readResult)
        {
            VehiclePosition vehLocation = theVehicle.CurVehiclePosition;
            try
            {
        ...
        public void Send_Cmd132_TransferCompleteReport()
        {
            ...
            try
            {
                ...
                iD_132_TRANS_COMPLETE_REPORT.CmdID = theVehicle.CurAgvcTransCmd.CommandId;
                iD_132_TRANS_COMPLETE_REPORT.CSTID = theVehicle.ThePlcVehicle.CassetteId;
        ...
        public void Send_Cmd131_TransferResponse(ushort seqNum, int replyCode, string reason)
        {
            try
            {
                ...
                iD_131_TRANS_RESPONSE.CmdID = theVehicle.CurAgvcTransCmd.CommandId;
        ...
        private BCRReadResult BCRReadResultParse(EnumIdReadResult readResult)
        {
            switch (readResult)
            {
                case EnumIdReadResult.Mismatch:
                    return BCRReadResult.BcrMisMatch;
                case EnumIdReadResult.Fail:
                    return BCRReadResult.BcrReadFail;
                case EnumIdReadResult.Noraml:
                default:
