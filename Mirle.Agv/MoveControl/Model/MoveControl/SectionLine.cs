...
namespace Mirle.AgvAseMiddler.Model
{
    public class SectionLine
    {
        ...
        public SectionLine(MapPosition start, MapPosition end, double angle, double encoderStart, bool dirFlag, double startByPassDistance = 0, double endByPassDistance = 0)
        {
            Start = start;
            SectionAngle = angle;
            End = end;
